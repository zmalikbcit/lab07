...
public final class Main
{
     ...
     */
    public static void printBook(final Book b)
    {
     ...
     */
    private static void processCheckout(final Library lib,
                                        final Book    book)
    {
    ...
    private static Library sampleLibrary()
    {
        ...
        books.add(new Book("The Great Gatsby",         Book.GENRE_FICTION,    1925, 180));
        books.add(new Book("Thinking, Fast & Slow",    Book.GENRE_NONFICTION, 2011, 499));
        books.add(new Book("Clean Code",               Book.GENRE_REFERENCE,  2008, 431));
        books.add(new Book("Dune",                     Book.GENRE_FICTION,    1965, 412));
        books.add(new Book("Sapiens",                  Book.GENRE_NONFICTION, 2011, 443));
        books.add(new Book("The Pragmatic Programmer", Book.GENRE_REFERENCE,  1999, 352));

        return new Library("BCIT Digital Library", books);
    }
    ...
    public static void main(final String[] args)
    {
        ...
        final List<Book> emptyList;
        final Library    extraLibrary;
        final Consumer<Book> instanceRef;

        emptyList    = new ArrayList<>();
        extraLibrary = new Library("Extra Library", emptyList);
        ...
        final Function<Book, String> typeRef;
        typeRef = Book::getTitle;

        System.out.println("\nType 3 (instance on any object of a type — Book::getTitle):");
        System.out.println(typeRef.apply(catalog.get(FIRST_BOOK_INDEX)));

        // Type 4 — Constructor reference: Book::new (copy constructor)
        final Function<Book, Book> constructorRef;
        final Book                 copiedBook;

        constructorRef = Book::new;
        ...
        final Shelf<Integer> pageCountShelf;
        pageCountShelf = new Shelf<>();
        ...
        final Shelf<String> titleShelf;
        titleShelf = new Shelf<>();
        ...
        final Library.LibraryStats stats;
        stats = new Library.LibraryStats();

        System.out.println(Book.GENRE_FICTION    + " count   : " +
                           stats.countByGenre(catalog, Book.GENRE_FICTION));
        System.out.println(Book.GENRE_NONFICTION + " count: " +
                           stats.countByGenre(catalog, Book.GENRE_NONFICTION));
        System.out.println(Book.GENRE_REFERENCE  + " count : " +
                           stats.countByGenre(catalog, Book.GENRE_REFERENCE));
        ...
        final Library.Librarian librarian;
